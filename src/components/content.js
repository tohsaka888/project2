...
const Content = ({
  ...
  const playlistDetail = async (id) => {
    ...
    const res1 = await fetch(
      `http://139.196.141.233:3000/comment/playlist?id=${id}`
    );
  ...
  const sign = async () => {
    const res = await fetch(
      `http://139.196.141.233:3000/daily_signin?type=1&cookie=${cookie}`,
      {
        mode: "cors",
      }
    );
  ...
  return (
    <div>
      <div style={{ overflow: "hidden", height: "40vh", marginTop: "64px" }}>
        <div
          style={{
            height: "3px",
            width: "100vw",
        ...
        >
          ...
          <div style={{ marginTop: "20px" }}>
            <span
              style={{ fontSize: "22px", fontFamily: "text", color: "white" }}
            >
              欢迎，
            </span>
            {loginStatus.code === 200 && (
      ...
      <Content className="content" style={{ background: "white" }}>
        <Menu mode="horizontal" style={{ borderBottom: "2px solid #C10D0C" }}>
          ...
          >
            <span style={{ fontSize: "20px", color: "black" }}>热门推荐</span>
          </Item>
        </Menu>
        ...
        {loginStatus.code === 200 && loginStatus && userLike && (
          <Menu mode="horizontal" style={{ borderBottom: "2px solid #C10D0C" }}>
            <Item
              ...
              icon={<EnvironmentOutlined style={{ color: "#C10D0C" }} />}
            >
              <span style={{ fontSize: "20px", color: "black" }}>为你推荐</span>
            </Item>
          </Menu>
        )}
        {loginStatus.code === 200 && loginStatus && userLike && (
        ...
        <Menu mode="horizontal" style={{ borderBottom: "2px solid #C10D0C" }}>
          <Item
            ...
            icon={<EnvironmentOutlined style={{ color: "#C10D0C" }} />}
          >
            <span style={{ fontSize: "20px", color: "black" }}>新碟上架</span>
          </Item>
        </Menu>
        <Tabs
          tabPosition="bottom"
            ...
            >
              {weekData &&
                weekData.slice(0, 5).map((item, index) => {
                  return (
                    <div
                      style={{ marginLeft: index === 0 ? "0px" : "4vw" }}
                      key={index}
                    >
                      <img
                        className="playlist"
        ...
        <Menu mode="horizontal" style={{ borderBottom: "2px solid #C10D0C" }}>
          <Item
            ...
            icon={<EnvironmentOutlined style={{ color: "#C10D0C" }} />}
          >
            <span style={{ fontSize: "20px", color: "black" }}>榜单</span>
          </Item>
        </Menu>
        ...
        <Menu mode="horizontal" style={{ borderBottom: "2px solid #C10D0C" }}>
          <Item
            ...
            icon={<EnvironmentOutlined style={{ color: "#C10D0C" }} />}
          >
            <span style={{ fontSize: "20px", color: "black" }}>人气歌手</span>
          </Item>
        </Menu>
        <Collapse
          defaultActiveKey={1}
          accordion
          style={{ marginTop: "20px", fontFamily: "title" }}
        >
          <Collapse.Panel
            key={1}
            header="中国最受欢迎歌手列表"
